...
public class Persona {
    ...
    public static boolean editarPersona(String dni, String nuevoNombre, String nuevoApellido) {
        ...
        if (pos >= 0) {
            ...
            // JOptionPane.showMessageDialog(null, "Persona editada correctamente."); Se
            // elimina mensaje, aparecerá en método editarCliente
            return true;
        }
        // JOptionPane.showMessageDialog(null, "Persona no encontrada."); Se elimina
        // mensaje, aparecerá en método editarCliente
        return false;
    }
    ...
    public static boolean eliminarPersona(String dni) {
        ...
        if (pos >= 0) {
            ...
            cantidad--;
            ordenarPorDni();
            // JOptionPane.showMessageDialog(null, "Persona eliminada correctamente."); Se
            // elimina mensaje, aparecerá en método eliminarCliente
            return true;
        }
        // JOptionPane.showMessageDialog(null, "Persona no encontrada."); Se elimina
        // mensaje, aparecerá en método eliminarCliente
        return false;
    }
